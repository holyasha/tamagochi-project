package com.example.tamagochi.auditservice.config;
...
public class RabbitMQConfig {
     ...
     * - "tamagochi.created"  → попадёт в очередь с binding key "tamagochi.*"
     * - "owner.deleted" → попадёт в очередь с binding key "#" (все события)
     *
     ...
     * - q.audit.tamagochis с "tamagochi.*" — только события тамагочи,
     * - q.notification.owners с "owner.created" — уведомления при создании владельца.
     */
    @Bean
