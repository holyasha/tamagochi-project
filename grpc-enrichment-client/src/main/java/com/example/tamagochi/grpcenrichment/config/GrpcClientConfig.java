 ...
 * - Для async используется TamagochiAnalyticsGrpc.newFutureStub() или newStub()
 *
...
public class GrpcClientConfig {
    ...
    /**
     * BlockingStub — синхронный клиент для вызова TamagochiAnalytics.AnalyzeTamagochi().
     *
     ...
     */
    @Bean
    public TamagochiAnalyticsGrpc.TamagochiAnalyticsBlockingStub tamagochiAnalyticsStub(ManagedChannel channel) {
        return TamagochiAnalyticsGrpc.newBlockingStub(channel);
    }
